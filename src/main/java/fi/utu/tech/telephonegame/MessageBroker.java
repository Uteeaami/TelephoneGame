...
public class MessageBroker extends Thread {
	 ...
	 * 1. Test the type of the incoming object || #DONE#
	 * 2. Keep track of messages that are already processed by this node || #DONE#
	 * 3. Show the incoming message in the received message text area || #DONE#
	 * 4. Change the text and the color using the Refiner class || #DONE#
	 * 5. Set the new color to the color area || #DONE#
	 * 6. Show the refined message in the refined message text area || #DONE#
	 * 7. Return the processed message || #DONE#
	 */
	private Message process(Object procMessage) {
		//Test the type of incoming object
	...
	public void send(Message message) {
		//Put message to prevMessages - !without this the sending node would also receive refined text!
